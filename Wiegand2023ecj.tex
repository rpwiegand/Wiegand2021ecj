...
%% RPW:  To produce the double-spaced version for copy-edit:
...
\ecjHeader{x}{x}{xxx-xxx}{2023}{Analysis of Simple Novelty Search}{R.P. Wiegand}
...
%% RPW:  I removed the Elhadef & Ayeb 2000 reference to make room for reviewer 3's suggested sentence 
...
%% RPW:  The last sentence was modified per reviewer 3's final instructions.
...
%% RPW:  I removed Seada & Deb 2018 citation to make room for reviewer 3's sentences.
...
%
\begin{figure}[ht]
  \center\begin{tikzpicture}[scale=0.55]
...
\begin{figure}[ht]
  \begin{center}
    \includegraphics[width=0.65\textwidth]{Figures/vizarchive-all-0s01-r02-mu1lam4.pdf}\\
